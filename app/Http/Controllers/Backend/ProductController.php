...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $product->ProductSlug = \Illuminate\Support\Str::slug($request->ProductName);
        ...
        // $size_chart_popup = $request->size_chart_popup;
        // if ($size_chart_popup) {
        //     $imgname2 = $time . $size_chart_popup->getClientOriginalName();
        //     $imguploadPath2 = ('public/images/product/');
        //     $size_chart_popup->move($imguploadPath2, $imgname2);
        //     $productImgUrl2 = $imguploadPath2 . $imgname2;
        //     $product->size_chart_popup = $productImgUrl2;
        //     $webp2 = $productImgUrl2;
        //     $im = imagecreatefromstring(file_get_contents($webp2));
        //     $new_webp2 = preg_replace('"\.(jpg|jpeg|png|webp)$"', '.webp', $webp2);
        //     imagewebp($im, $new_webp2, 50);
        //     $product->size_chart_popup = $new_webp2;
        // }
        // dd($request->all());
        $result = $product->save();
