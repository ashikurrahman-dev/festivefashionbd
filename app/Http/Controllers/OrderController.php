...
class OrderController extends Controller
{
    ...
    {
        // $custMail = 'greenieagroinbox@gmail.com';
        ...
        if (!Session::has('cart')) {
            ...
            if ($result) {
                ...
                //         'customerEmail' => $request->customerMail,
                //         'customerAddress' => $customer->customerAddress,
                //         'paymentMethod' => $order->payment_type_id == 2 ? 'Cash on Delivery' : 'Online Payment',
                //         'deliveryCharge' => $order->deliveryCharge,
                //         'subTotal' => $request->subTotal,
                //         'total' => $order->subTotal,
                //         'products' => $products,
                //     ];
                //     Mail::to($custMail)->send(new NotificationMail($confirmMail));
                // }
