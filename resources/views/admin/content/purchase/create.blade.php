                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4 row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-2 form-group trx_id">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="comments" class="form-control" placeholder="Payment Notes" id="comments"
                                        rows="2"> </textarea>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-2 form-group row">
                                    <label for="fname"
                                        class="text-right col-sm-4 control-label col-form-label">Transport</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="mb-2 form-group row paymentAmount">
                                    <label for="fname" class="text-right col-sm-4 control-label col-form-label">Payment
                                        Amount</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="mb-2 form-group row">
                                    <label for="fname"
                                        class="text-right col-sm-4 control-label col-form-label">Total</label>
                                    <div class="col-sm-8">
                ...
                <div class="card">
                    ...
                    <div class="text-right card-footer">
                        <button type="button" id="submit" class="btn btn-primary btn-block" data-style="expand-left"
                            style="width: 25%;font-size: 22px;">Save</button>
                    </div>
                </div>
            </div>
        </div>
