                                          ...
                                          <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-group mb-3">
                                                            <label for="ProductDetails">Size Chart Image <span
                                                                    class="text-danger"></span></label>
                                                            <button type="button" class="btn btn-danger d-block mb-2"
                                                                style="background: red">
                                                                <input type="file" name="size_chart_popup" id="size_chart_popup"
                                                                    onchange="loadFile2(event)">
                                                            </button>
                                                            <div class="single-image image-holder-wrapper clearfix">
                                                                <div class="image-holder placeholder">
                                                                    <img id="prevImage2" src="{{ asset($product->size_chart_popup) }}" style="height:100px;width:100px" />
                                                                    <i class="mdi mdi-folder-image"></i>
                                                                </div>
                                                            </div>
                                                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on("click", "#submit", function () {
            ...
            if($("#size_chart_popup").val()==''){
                formData.append('size_chart_popup', '');
            }else{
                formData.append('size_chart_popup', $('#size_chart_popup')[0].files[0]);
            }
